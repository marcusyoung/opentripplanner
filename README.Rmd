...
Instructions for installing OTP on Linux can be found in the [`getting-started` vignette](https://github.com/ITSLeeds/opentripplanner/blob/master/vignettes/getting_started.Rmd).
...
Tests only run on machines that have the environment variable `I_have_OTP` with the value `TRUE`.
